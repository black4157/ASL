...
<c:forEach items="${PSL_FT1 }" var="AVG1">
	<script>
	...
	<div class="ft_avg">
		<script>
			function avg(AvgScore) {
			    ...
			    return Math.round(result / parseFloat(AvgScore1.length));
			}
...
<script>
	...
	function drawChart() {
		...
		var chart = new google.visualization.ComboChart(document.getElementById("columnchart_values3"));
