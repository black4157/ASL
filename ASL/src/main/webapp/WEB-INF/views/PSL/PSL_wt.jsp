...
<div class="wt_graph">
	...
	<%@ include file="./PSL_graph1.jsp" %>

	<%@ include file="./PSL_graph2.jsp" %>

</div>

<div class="wt_stare">

	<%@ include file="./PSL_stare1.jsp" %>

	<%@ include file="./PSL_stare2.jsp" %>
...
<script>
	$(document).ready(function() {
		$("#btn").on("click",function(event) {
			self.location = "PSL_Define?year=" + $("select option:selected").val();
