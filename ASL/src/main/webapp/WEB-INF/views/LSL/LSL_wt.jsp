...
<div class="wt_graph">
	...
	<%@ include file="./LSL_graph1.jsp" %>

	<%@ include file="./LSL_graph2.jsp" %>

</div>

<div class="wt_stare">

	<%@ include file="./LSL_stare1.jsp" %>

	<%@ include file="./LSL_stare2.jsp" %>
...
<script>
	$(document).ready(function() {
		$("#btn").on("click",function(event) {
			self.location = "LSL_Define?year=" + $("select option:selected").val();
