...
<c:forEach items="${DSL_FT1 }" var="AVG1">
	<script>
...
<!-- 1급그래프 출력 -->
<div class="ft_graph1">
	<h2 class="graph_title">2019년 1급 평균합격점</h2>
	<div class="ft_avg">
		<script>
			...
			document.write("<p>" + Year1[0] + "년의 실기 총 평균 : " + avg(AvgScore3) + "</p>");
			document.write("<p>" + Year1[0] + "년의 실기 구술 평균 : " + avg(AvgScore4) + "</p>");
	</script>
	</div>
