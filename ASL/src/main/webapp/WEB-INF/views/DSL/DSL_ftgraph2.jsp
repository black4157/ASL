...
<c:forEach items="${DSL_FT2 }" var="AVG1">
	<script>
...
<div class="ft_graph2">
	...
	<div class="ft_avg">
		<script>
			...
			document.write("<p>" + Year2[0] + "년 ~ " + Year2[3] + "년까지의 실기 총 평균 : " + avg(AvgScore5) + "</p>");
			document.write("<p>" + Year2[0] + "년 ~ " + Year2[3] + "년까지의 실기 구술 평균 : " + avg(AvgScore6) + "</p>");
		</script>
	</div>
...
<script>
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
		  ...
		  [Year2[0], parseFloat(AvgScore5[0]), parseFloat(AvgScore6[0]), "silver"],
		  [Year2[1], parseFloat(AvgScore5[1]), parseFloat(AvgScore6[1]), "gold"],
		  [Year2[2], parseFloat(AvgScore5[2]), parseFloat(AvgScore6[2]), "red"],
		  [Year2[3], parseFloat(AvgScore5[3]), parseFloat(AvgScore6[3]), "bule"]
		]);
