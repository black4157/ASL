...
<script type="text/javascript">
	...
	<!-- 배열에 jstl값 넣기 (2급) -->
<c:forEach items="${DSL_AvgScore2 }" var="AVG2">
	<script>
		Year2.push("${AVG2.EFC_YY}");
...
<div class="wt_graph2">
	...
	<div class="wt_avg">
		<script>
			...
			document.write(Year2[0] + "년 ~ " + Year2[3] + "년까지의 평균 : " + avg(AvgScore2));
		</script>
	</div>
...
<script>
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
		  ...
		  [Year2[0], parseFloat(AvgScore2[0]), "silver"],
		  [Year2[1], parseFloat(AvgScore2[1]), "gold"],
		  [Year2[2], parseFloat(AvgScore2[2]), "red"],
		  [Year2[3], parseFloat(AvgScore2[3]), "bule"]
		]);
